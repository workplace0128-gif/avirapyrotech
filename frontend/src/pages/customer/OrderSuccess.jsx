    ...
    <div className="max-w-xl mx-auto px-4 py-16 text-center space-y-8 animate-fade-in">
      ...
      <div className="bg-white rounded-3xl border border-gray-150 p-8 shadow-sm space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-black font-outfit text-gray-900 tracking-tight">Order Placed Successfully!</h1>
          <p className="text-xs text-gray-400 font-semibold leading-relaxed">
            Thank you for shopping with Avira Pyrotech. Your order has been registered in our database.
          </p>
        </div>
        ...
        <div className="bg-yellow-50/50 border border-yellow-100 p-4 rounded-xl text-left text-yellow-800 text-xs font-medium space-y-1">
          <p className="font-extrabold text-yellow-950 flex items-center gap-1.5">
            <PhoneCall size={14} className="text-orange-500" />
            <span>Next steps</span>
          </p>
          <p className="leading-relaxed text-yellow-900 font-semibold">Our packaging and delivery team will contact you shortly via phone to confirm your address details and schedule the transport vehicle. Payment will be collected upon delivery.</p>
        </div>
